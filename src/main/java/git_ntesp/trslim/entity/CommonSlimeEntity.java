...
public class CommonSlimeEntity extends Monster {
	public CommonSlimeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TrslimModEntities.COMMON_SLIME.get(), world);
	}

	public CommonSlimeEntity(EntityType<CommonSlimeEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 1;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(TrslimModEntities.COMMON_SLIME.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
